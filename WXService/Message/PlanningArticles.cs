...
namespace WXService.Message
{
    ...
    {
        private string picUrl = "http://spjs.chinacloudsites.cn/static/";
        /// <summary>
        /// 办理生育服务证
        /// </summary>
        /// <returns></returns>
        public List<Article> GetBirthArticles()
        {
            ...
            articleOne.Url = picUrl+"11OneBaby.html";
            ...
            articleTwo.Url = picUrl+"12ReBirth.html";
            ...
            articleThree.Url = picUrl+"13PlanBirth.html";
        ...
        public List<Article> GetMarriageArticles()
        {
            ...
            articleOne.Url = picUrl+"21FlowWebBirth.html";
            ...
            articleTwo.Url = picUrl+"22MarriedWebBirth.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = picUrl+"23FloatingPopulationWebBirth.html";
            Articles.Add(articleThree);
            return Articles;
        }
        ...
        public List<Article> GetPlanningArticles()
        {
            ...
            articleOne.Url = picUrl+"31EveryPlanProve.html";
            ...
            articleTwo.Url = picUrl+"32InProvinceFloatingPopulationPaln.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = picUrl+"33FloatingPopulationPaln.html";
            Articles.Add(articleThree);
            ...
            articleFour.Url = picUrl+"34OneChildParents.html";
        ...
        public List<Article> GetAidsArticles()
        {
            ...
            articleOne.Url = picUrl+"41CountryFamilyBonus.html";
            ...
            articleTwo.Url = picUrl+"42CountryPlanBonus.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = picUrl+"43CityParentPlanBonus.html";
            Articles.Add(articleThree);
            Article articleFour = new Article();
            ...
            articleFour.Url = picUrl+"44PlanFamilySpecialBonus.html";
            Articles.Add(articleFour);
            return Articles;
        }
        ...
        public List<Article> GetOneTwoArticles()
        {
            ...
            articleOne.Url = picUrl+"51DefinitionOnlyChild.html";
            ...
            articleTwo.Url = picUrl+"52OnlyTowChildJoin.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = picUrl+"53MarriedAgainBirth.html";
            Articles.Add(articleThree);
            Article articleFour = new Article();
            ...
            articleFour.Url = picUrl+"54MarriedAgainBirthApproval.html";
            Articles.Add(articleFour);
            return Articles;
        }
        ...
        public List<Article> GetCooperativeArticles()
        {
            ...
            articleOne.Url = picUrl+"61RuralCooperativeApplication.html";
            ...
            articleTwo.Url = picUrl+"62RuralCooperativeAppliedData.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = picUrl+"63RuralCooperativeGoThrough.html";
            Articles.Add(articleThree);
            return Articles;
        }
        ...
        public List<Article> GetRewardArticles()
        {
            ...
            articleOne.Url = picUrl+"71RuralFamilyPlanningReward.html";
            ...
            articleTwo.Url = picUrl+"72RuralPlanningBirthControlReward.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = picUrl+"73TownFamilyPlanningReward.html";
            Articles.Add(articleThree);
            Article articleFour = new Article();
            ...
            articleFour.Url = picUrl+"74FamilyPlanningSpecialAssistance.html";
            Articles.Add(articleFour);
            return Articles;
        }
        ...
        public List<Article> GetLawArticles()
        {
            ...
            CantonPlanningLaw.Url = picUrl+"CantonPlanningLaw.html";
        ...
        public List<Article> GetCharacteristicArticles()
        {
            ...
            articleOne.Url = picUrl+"AutonomousDemonstration.html";
        ...
        public List<Article> GetHealthArticles()
        {
            ...
            articleOne.Url = picUrl + "H7N9.html";
            ...
            articleTwo.Url = picUrl + "NorwalkViruses.html";
