...
namespace WXService.Message
{
    public class PlanningArticles
    {
        ...
        public List<Article> GetBirthArticles()
        {
            ...
            articleOne.Url = "http://flylxee.chinacloudsites.cn/static/11OneBaby.html";
            ...
            articleTwo.Url = "http://flylxee.chinacloudsites.cn/static/12ReBirth.html";
            ...
            articleThree.Url = "http://flylxee.chinacloudsites.cn/static/13PlanBirth.html";
        ...
        public List<Article> GetMarriageArticles()
        {
            ...
            articleOne.Url = "http://flylxee.chinacloudsites.cn/static/21FlowWebBirth.html";
            ...
            articleTwo.Url = "http://flylxee.chinacloudsites.cn/static/22MarriedWebBirth.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = "http://flylxee.chinacloudsites.cn/static/23FloatingPopulationWebBirth.html";
            Articles.Add(articleThree);
            return Articles;
        }
        ...
        public List<Article> GetPlanningArticles()
        {
            ...
            articleOne.Url = "http://flylxee.chinacloudsites.cn/static/31EveryPlanProve.html";
            ...
            articleTwo.Url = "http://flylxee.chinacloudsites.cn/static/32InProvinceFloatingPopulationPaln.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = "http://flylxee.chinacloudsites.cn/static/33FloatingPopulationPaln.html";
            Articles.Add(articleThree);
            ...
            articleFour.Url = "http://flylxee.chinacloudsites.cn/static/34OneChildParents.html";
        ...
        public List<Article> GetAidsArticles()
        {
            ...
            articleOne.Url = "http://flylxee.chinacloudsites.cn/static/41CountryFamilyBonus.html";
            ...
            articleTwo.Url = "http://flylxee.chinacloudsites.cn/static/42CountryPlanBonus.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = "http://flylxee.chinacloudsites.cn/static/43CityParentPlanBonus.html";
            Articles.Add(articleThree);
            Article articleFour = new Article();
            ...
            articleFour.Url = "http://flylxee.chinacloudsites.cn/static/44PlanFamilySpecialBonus.html";
            Articles.Add(articleFour);
            return Articles;
        }
        ...
        public List<Article> GetOneTwoArticles()
        {
            ...
            articleTwo.PicUrl = "https://mmbiz.qlogo.cn/mmbiz/WQN53PGdv3PnIbiaS1iciapMHvdecoQj7mDOOWV3SFxpia5DwhmpQTVD5M1XRM6GXHmsQV7WicYqyfFDAPXNk3lELrg/0";
            articleTwo.Url = "http://flylxee.chinacloudsites.cn/static/52OnlyTowChildJoin.html";
            Articles.Add(articleTwo);
            Article articleThree = new Article();
            ...
            articleThree.Url = "http://flylxee.chinacloudsites.cn/static/53MarriedAgainBirth.html";
            Articles.Add(articleThree);
            Article articleFour = new Article();
            ...
            articleFour.Url = "http://flylxee.chinacloudsites.cn/static/54MarriedAgainBirthApproval.html";
            Articles.Add(articleFour);
            return Articles;
        }
        ...
        public List<Article> GetLawArticles()
        {
            ...
            CountryPlanningLaw.PicUrl = "https://mmbiz.qlogo.cn/mmbiz/WQN53PGdv3PnIbiaS1iciapMHvdecoQj7mDnDNVibfP7iakQ4DC4UVCXvtlgV6VaUTiaB6fRJ2sDZOE0DFkuE96YxxQA/0";
