...
namespace WXService.Message
{
    public class PlanningCertificateMsg
    {
        ...
        public string GetOneBabyMsg()
        {
            ...
            sb.Append("2、如果女方为外省籍人口，男方为本地户籍人口，须提供女方户籍地乡镇（街）计生办出具的婚育状况证明，并同意在男方申请一孩生育登记手续方可办理。").Append("\n");
            sb.Append("3、如果女方为本省籍非沙坪户口，须回女方户籍地计生部门申办。");
            return sb.ToString();
        }
        ...
        public string GetCountryFamilyBonusMsg()
        {
            ...
            sb.Append("1、符合奖励条件人员持本人身份证、户口簿及有关证明材料向户籍地村委会领取并填写《广东省农村计划生育奖励金申请表》；").Append("\n");
        ...
        public string GetCountryPlanBonusMsg()
        {
            ...
            sb.Append("1、凡符合奖励条件沙坪街道的农村居民持本人身份证、户口簿、结婚证、绝育证明书、计划生育服务证及有关证明材料，向户籍地村委会领取并填写《江门市农村计划生育节育奖励金申请表》；").Append("\n");
        ...
        public string GetCityParentPlanBonusMsg()
        {
            ...
            sb.Append("凡符合奖励条件的沙坪街道城镇户籍独生子女父母，均可持居民身份证、夫妻双方户口簿、结婚证、小孩出生证、独生子女父母光荣证或单位证明、退休证（单位退休须提供）、收养证或收养公证书（属收养须提供）等材料的原件和复印件，");
        ...
        public string GetPlanFamilySpecialBonusMsg()
        {
            ...
            sb.Append("凡符合规定扶助条件的沙坪街道户籍独生子女父母，均可持居民身份证、户口簿、结婚证、独生子女父母光荣证、收养证或收养公证书、独生子女的残疾人证或死亡证等材料的原件和复印件，免冠（1寸）近照3张，向户籍所在地的村（居）民委员会申请，领取并填写一式三份的《广东省计划生育家庭特别扶助金申请表》，交由村（居）民委员会代办。").Append("\n");
